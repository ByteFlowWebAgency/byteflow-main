            ...
            <div className={styles.container}>
                <div className={styles.grid}>
                    ...
                    <div className={styles.linkCol}>
                        ...
                        <Link href="/about#team" className={styles.link}>Leadership</Link>
                        <Link href="/contact" className={styles.link}>Careers</Link>
                    </div>
                    <div className={styles.linkCol}>
                        <h4 className={styles.colHeader}>Services</h4>
                        <Link href="/services" className={styles.link}>Enterprise Software</Link>
                        <Link href="/services" className={styles.link}>AI Integration</Link>
                        <Link href="/services" className={styles.link}>Cloud Solutions</Link>
                        <Link href="/services" className={styles.link}>Consulting</Link>
                    </div>
                    <div className={styles.linkCol}>
                ...
                <div className={styles.bottomRow}>
                    <p>© 2025 BYTEFLOW. All rights reserved.</p>
                    <a href="mailto:support@byteflowsolutions.com">support@byteflowsolutions.com</a>
                </div>
            </div>
        </footer>
    );
